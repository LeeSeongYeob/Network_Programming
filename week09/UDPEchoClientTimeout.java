...
public class UDPEchoClientTimeout {
	...
	public static void main(String args[]) {
		...
		try {
			...
			System.out.println("Attemping to connect to " + uServer + ") via UDP port " + uPort);
	...
	public UDPEchoClientTimeout(InetAddress uServer) {
		...
		try {
			...
			try {
				...
				InetAddress returnIPAdress = receivePacket.getAddress();
				int port = receivePacket.getPort();

				System.out.println("From: " + returnIPAdress + ":" + port);
				System.out.println("Message: " + modifiedSentence);
				System.out.println("Addsome: " + modifiedSentence.toLowerCase());
